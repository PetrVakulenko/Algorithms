package Math.FindPositiveIntegerSolutionForAGivenEquation_1237;
...
class CustomFunction1 implements CustomFunction
{
    @Override
    public int f(int x, int y) {
        return x*y;
...
class CustomFunction2 implements CustomFunction
{
    @Override
    public int f(int x, int y) {
        return x+y;
